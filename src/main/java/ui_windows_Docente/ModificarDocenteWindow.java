...
public class ModificarDocenteWindow extends Dialog<ModificarDocenteModelView> {

	public ModificarDocenteWindow(WindowOwner owner, Docente docente) {
		super(owner, new ModificarDocenteModelView(docente));
	}
